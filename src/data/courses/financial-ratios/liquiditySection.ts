...
<div className="formula-display">
  <span className="fraction">
    <span className="numerator">Actifs circulants</span>
    <span className="denominator">Passifs à court terme</span>
  </span>
</div>
...
<div className="formula-display">
  <span className="fraction">
    <span className="numerator">Liquidités + Créances clients</span>
    <span className="denominator">Passifs à court terme</span>
  </span>
</div>
